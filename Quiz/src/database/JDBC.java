...
public class JDBC {
    ...
    private static final String DB_PASSWORD = "x2t000105event";
    ...
    public static boolean saveQuestionCategoryAndAnswersToDatabase(String question, String category,
        ...
        try {
            ...
            if (categoryObj == null) {
                System.err.println("Failed to insert/get category");
                return false;
            }

            Question questionObj = insertQuestion(categoryObj, question);
            if (questionObj == null) {
                System.err.println("Failed to insert question");
                return false;
            }
        ...
        try {
            ...
            PreparedStatement getAnswersQuery = connection.prepareStatement(
                    "SELECT * FROM QUESTION JOIN ANSWER " +
                            "ON QUESTION.CATEGORY_ID = ANSWER.QUESTION_ID " +
